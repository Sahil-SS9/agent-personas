...
| Input | Insert Path |
|-------|-------------|
| Article file path (default `imgs-subdir`) | `![description](https://example.invalid/placeholder)` |
| Article file path (images alongside) | `![description](https://example.invalid/placeholder)` |
| Article file path (`illustrations/` subdirectory) | `![description](https://example.invalid/placeholder)` |
| Pasted content | `![description](https://example.invalid/placeholder)` (relative to cwd) |
